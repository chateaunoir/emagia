<script>
    var luck_probability = function (n) {
        n = n / 100;
    ...
    function battle(player1, player2) {
        ...
        while (true) {
            ...
            if (player1.hp >= 1) {
                if (luck_probability(player2.lk)) {
                    if (debug) console.log('PL1 loveste cu ' + player1.st + ' dar PL2 are noroc si ramane cu ' + player2.hp);
                } else {
            ...
            if (player2.hp >= 1) {
                if (luck_probability(player1.lk)) {
                    if (debug) console.log('PL2 loveste cu ' + player2.st + ' dar PL1 are noroc si ramane cu ' + player1.hp);
                } else {
